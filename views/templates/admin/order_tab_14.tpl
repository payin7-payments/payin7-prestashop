...
<style>
    .payin7-order-details .panel-body {
        padding: 0;
    }

    .payin7-order-details a.open-in-payin7 {
        font-size: 130%;
    }
</style>
<fieldset style="width: 400px; margin-top: 20px;" class="payin7-order-details">
    <legend>{l s='Payin7 Order Details' mod='payin7'}</legend>
