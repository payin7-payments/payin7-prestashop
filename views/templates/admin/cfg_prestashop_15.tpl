...
<div class="panel">
    ...
    <div class="row header payin7-config-container">
        <div class="col-lg-8 payin7-config-info-container">
        ...
        <div class="payin7-config-img-container col-lg-4 pull-right text-right">
